...
hero:
  ...
  prelink:
    title: '<p style="text-align: left;"><i class="fa-solid fa-bolt fa-shake" style="color: #FFD43B;"></i> 快速开始</p><div style="text-align: left; font-weight: bold; word-break: break-all; overflow-wrap: break-word;">https://xiaoha.q2.hk/</div>'
  image:
    src: /logo.png
  actions:
    - theme: brand
...
features:
  ...
  - title: 3D地图
    ...
    details: 支持在网页或者手机直接查看游戏内玩家位置和坐标等…… 欢迎访问我们的商店官网https://xiaoha.q2.hk/
  - title: 开放API
